...
class HST(nn.Module):
    ...
    def __init__(self, adjacencyMatrix, wordFeatures,
                 ...
                 intraMargin=1.0, isIntraMarginLearnable=False, interMargin=1.0, isInterMarginLearnable=False, useSoftTarget=False):
        ...
        self.isIntraMarginLearnable = isIntraMarginLearnable
        self.isInterMarginLearnable = isInterMarginLearnable

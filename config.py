...
def arg_parse(mode):
    ...
    assert mode in ('SSGRL', 'MLGCN', 'SST')
    ...
    parser.add_argument('--mode', type=str, default='SSGRL', help='mode of experiment (default: SST)')
    ...
    # aux model
    parser.add_argument('--auxModel', type=str, default='None', help='aux model')
    ...
    if args.dataset == 'COCO2014':
        ...
        args.trainImageList='/data1/2022_stu/wikim_exp/mlp-pl/data/vg/train_list_500.txt'
        args.testImageList='/data1/2022_stu/wikim_exp/mlp-pl/data/vg/test_list_500.txt'
        args.trainLabel='/data1/2022_stu/wikim_exp/mlp-pl/data/vg/vg_category_200_labels_index.json'
        args.testLabel='/data1/2022_stu/wikim_exp/mlp-pl/data/vg/vg_category_200_labels_index.json'
